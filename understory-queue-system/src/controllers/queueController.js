...
export async function forceReady(req, res) {
  try {
    ...
    return res.status(500).json({ error: "forceReady error" });
  }
}
...
export async function joinQueue(req, res) {
  try {
    ...
    return res.status(500).json({ error: "joinQueue server error" });
  }
}
...
export async function getQueueStatus(req, res) {
  try {
    ...
    return res.status(500).json({ error: "getQueueStatus server error" });
  }
}
...
export async function claim(req, res) {
  try {
    ...
    return res.status(500).json({ error: "claim server error" });
  }
}
